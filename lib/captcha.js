...
exports.serve = (options) => {
    ...
    app.post('/render', (req, res) => {
        ...
        // TODO redis client的操作都是非同步的，無法用while迴圈做這段
        //  saveRedis 非同步檢查到重覆key才會throw 'exist key' 回來
        //  這時候while迴圈已經跑了十次出去，畫完圖回傳前端之後才報錯
